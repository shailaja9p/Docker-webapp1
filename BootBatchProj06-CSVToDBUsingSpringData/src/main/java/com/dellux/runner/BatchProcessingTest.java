...
@Component
public class BatchProcessingTest implements CommandLineRunner {
	...
	/*
	 * @Scheduled(cron="${cron.expr}") public void runJob() throws Exception{
	 * System.out.println(new Date()); JobParameters params = new
